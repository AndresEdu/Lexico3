...
// :DDD Requerimiento 1: Levantar la excepción en caso de error e identificar el tipo de error.
// :DDD Requerimiento 2: Indicar en que línea y caracter se encuentra el error.
// :DDD Requerimiento 3: Agregar el token { y } en la matriz trand6x. Nota: Agregar las columnas de llave abierta y llaves cerradas 
// :DDD Requerimiento 4: Agregar los comentarios de linea y multilinea. Nota: Agregar la columna #10
// :DDD Requerimiento 5: Grabar en el archivo log los errores lexicos.
